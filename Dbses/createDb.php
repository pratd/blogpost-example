...
post_title TEXT NOT NULL, Key_words TEXT NOT NULL, post_author VARCHAR(60) NOT NULL, 
...
comment_approval VARCHAR(20) DEFAULT 'yes' )";
...
user_login VARCHAR(60) NOT NULL, user_pass VARCHAR(50) NOT NULL )";
